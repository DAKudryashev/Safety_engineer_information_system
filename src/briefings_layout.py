...
class BriefingsLayout(QWidget):
    def __init__(self):
        ...
        self.reg_buttons_widget.setFixedHeight(225)
        ...
        self.comp_buttons_widget.setFixedHeight(225)
    ...
    def fill_planned_table(self, data):
        ...
        self.planned_table.setColumnWidth(0, 900)
        self.planned_table.setColumnWidth(1, 350)
        self.planned_table.setColumnWidth(2, 200)
        self.planned_table.setColumnWidth(3, 350)
        self.planned_table.setColumnWidth(4, 250)
        self.planned_table.setVerticalScrollBarPolicy(Qt.ScrollBarAlwaysOn)  # Вертикальный scrollbar всегда виден
        self.planned_table.setHorizontalHeaderLabels(['Название',
                                                      'Содержание',
                                                      'Дата проведения',
                                                      'Ответственный',
                                                      'Регулирующий документ'])

    def fill_completed_documents(self, data):
        ...
        self.completed_table.setColumnWidth(0, 900)
        self.completed_table.setColumnWidth(1, 350)
        self.completed_table.setColumnWidth(2, 200)
        self.completed_table.setColumnWidth(3, 350)
        self.completed_table.setColumnWidth(4, 250)
        self.completed_table.setVerticalScrollBarPolicy(Qt.ScrollBarAlwaysOn)  # Вертикальный scrollbar всегда виден
        self.completed_table.setHorizontalHeaderLabels(['Название',
                                                        'Содержание',
                                                        'Дата проведения',
                                                        'Ответственный',
                                                        'Регулирующий документ'])
