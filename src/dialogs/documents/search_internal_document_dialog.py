...
class SearchInternalDialog(QDialog):
    def __init__(self, parent=None):
        super().__init__(parent)
        self.setWindowTitle("Найти документ")
        ...
        self.author_input.setPlaceholderText("ФИО добавившего")

        # Надпись об ошибке (будем использовать для проверки дат)
        ...
        form_layout.addRow("Добавил:", self.author_input)
    ...
    def get_search_params(self):
        ...
        return {
            ...
            'responsible': self.author_input.text().strip()
        }