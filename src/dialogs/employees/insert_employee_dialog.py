...
class InsertEmployeeDialog(QDialog):
    def __init__(self, briefings, exams, medical_exams, parent=None):
        ...
        self.briefing_combo.setCurrentIndex(0)
        ...
        self.medical_exam_combo.setCurrentIndex(0)
